...
export const LeftPanelConversations = ({
    ...
    const leftPanelContentPushGroupCreation = () => {
        ...
        dispatch(addConversation({}))
            .then(unwrapResult)
            .then((conversationMeta) =>
                dispatch(push(`/conversation/${conversationMeta.conversation.id}`))
            )
    ...
    return (
        <>
            ...
            <Box style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <IconButton style={{ marginLeft: 'auto' }} onClick={leftPanelContentPushInvitation}>
                    <PersonAddIcon />
                </IconButton>
